document.addEventListener('DOMContentLoaded', () => {
  ...
  <div class="modal-content">
    ...
    <h2>DEMANDE DE CLOTURE DU PROCESS DE TRAITEMENT D'UN SINISTRE</h2>
    <form id="claimForm">
  

      
<fieldset>
<legend>DOSSIER CONCERNE PAR LA DEMANDE</legend>
...
background-color: #0057b3ea;">Envoyez la requête</button>
    </form>
  </div>
</div>
    ...
    const updateClaimTable = () => {
        ...
        claims.forEach(claim => {
          ...
          <td>${claim.adr_sin}</td>
          <td>
          <button id="btn-confirmer" class="view-btn-confirmer">Démarrer </button> <button id="btn-modifie" class="view-btn-modifier">En cour</button> <button id="btn-supprimer" class="view-btn-supprimer">Achevé</button>  
